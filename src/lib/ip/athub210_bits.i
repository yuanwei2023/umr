static struct umr_bitfield mmATHUB_ATS_MODE_CNTL[] = {
	 { "HOST_TRANS_ENABLE", 0, 0, &umr_bitfield_default },
	 { "CONSOLE_IOV_ENABLE", 1, 1, &umr_bitfield_default },
};
...
static struct umr_bitfield mmATC_ATS_CNTL[] = {
	 ...
	 { "GUEST_TRANS_MISS_MODE", 24, 24, &umr_bitfield_default },
	 { "KEEP_VMID_BUSY_BY_INTR", 25, 25, &umr_bitfield_default },
};
...
static struct umr_bitfield mmATHUB_MISC_CNTL[] = {
	 { "CG_OFFDLY", 0, 5, &umr_bitfield_default },
	 { "CG_ENABLE", 6, 6, &umr_bitfield_default },
	 { "CG_MEM_LS_ENABLE", 7, 7, &umr_bitfield_default },
	 { "PG_ENABLE", 8, 8, &umr_bitfield_default },
	 { "PG_OFFDLY", 9, 14, &umr_bitfield_default },
	 { "ALWAYS_BUSY", 15, 15, &umr_bitfield_default },
	 { "CG_STATUS", 16, 16, &umr_bitfield_default },
	 { "PG_STATUS", 17, 17, &umr_bitfield_default },
	 { "RPB_BUSY", 18, 18, &umr_bitfield_default },
	 { "XPB_BUSY", 19, 19, &umr_bitfield_default },
	 { "ATS_BUSY", 20, 20, &umr_bitfield_default },
	 { "SDPNCS_BUSY", 21, 21, &umr_bitfield_default },
	 { "DFPORT_BUSY", 22, 22, &umr_bitfield_default },
	 { "SWITCH_CNTL", 23, 23, &umr_bitfield_default },
};
...
static struct umr_bitfield mmATC_ATS_CNTL2[] = {
	 { "CREDITS_ATS_RPB_MMTR", 0, 7, &umr_bitfield_default },
	 { "CREDITS_ATS_RPB_GFXTR", 8, 15, &umr_bitfield_default },
	 { "CREDITS_ATS_RPB_PRINV", 16, 23, &umr_bitfield_default },
	 { "TRANSLATION_STALL", 24, 24, &umr_bitfield_default },
	 { "INV_PASID_CONSOLE_IOV", 25, 25, &umr_bitfield_default },
	 { "GC_MM_TRANS_SWITCH", 26, 26, &umr_bitfield_default },
	 { "GC_TRANS_CONTROL", 27, 27, &umr_bitfield_default },
	 { "MM_TRANS_CONTROL", 28, 28, &umr_bitfield_default },
	 { "RESERVED", 29, 31, &umr_bitfield_default },
};
static struct umr_bitfield mmATC_ATS_TR_QOS_CNTL[] = {
	 { "MM_TR_WQ_CREDITS", 0, 7, &umr_bitfield_default },
	 { "GFX_TR_WQ_CREDITS", 8, 15, &umr_bitfield_default },
	 { "GFX_MM_TR_ARB_MODE_AGGR", 16, 17, &umr_bitfield_default },
	 { "GFX_MM_TR_RATIO_AGGR", 18, 23, &umr_bitfield_default },
	 { "GFX_MM_TR_ARB_MODE_WQ", 24, 25, &umr_bitfield_default },
	 { "GFX_MM_TR_RATIO_WQ", 26, 31, &umr_bitfield_default },
};
static struct umr_bitfield mmATC_ATS_MISC_CNTL[] = {
	 { "MM_32K_GROUPING_EN_HOST", 0, 0, &umr_bitfield_default },
	 { "GFX_32K_GROUPING_EN_HOST", 1, 1, &umr_bitfield_default },
	 { "MM_32K_GROUPING_EN_GUEST", 2, 2, &umr_bitfield_default },
	 { "GFX_32K_GROUPING_EN_GUEST", 3, 3, &umr_bitfield_default },
...
static struct umr_bitfield mmXPB_RTR_SRC_APRTR10[] = {
	 { "BASE_ADDR", 0, 30, &umr_bitfield_default },
};
static struct umr_bitfield mmXPB_RTR_SRC_APRTR11[] = {
	 { "BASE_ADDR", 0, 30, &umr_bitfield_default },
};
static struct umr_bitfield mmXPB_RTR_SRC_APRTR12[] = {
	 { "BASE_ADDR", 0, 30, &umr_bitfield_default },
};
static struct umr_bitfield mmXPB_RTR_SRC_APRTR13[] = {
	 { "BASE_ADDR", 0, 30, &umr_bitfield_default },
};
...
static struct umr_bitfield mmXPB_RTR_DEST_MAP10[] = {
	 { "NMR", 0, 0, &umr_bitfield_default },
	 { "DEST_OFFSET", 1, 19, &umr_bitfield_default },
	 { "DEST_SEL", 20, 23, &umr_bitfield_default },
	 { "DEST_SEL_RPB", 24, 24, &umr_bitfield_default },
...
static struct umr_bitfield mmXPB_RTR_DEST_MAP11[] = {
	 { "NMR", 0, 0, &umr_bitfield_default },
	 { "DEST_OFFSET", 1, 19, &umr_bitfield_default },
	 { "DEST_SEL", 20, 23, &umr_bitfield_default },
	 { "DEST_SEL_RPB", 24, 24, &umr_bitfield_default },
...
static struct umr_bitfield mmXPB_RTR_DEST_MAP12[] = {
	 { "NMR", 0, 0, &umr_bitfield_default },
	 { "DEST_OFFSET", 1, 19, &umr_bitfield_default },
	 { "DEST_SEL", 20, 23, &umr_bitfield_default },
	 { "DEST_SEL_RPB", 24, 24, &umr_bitfield_default },
...
static struct umr_bitfield mmXPB_RTR_DEST_MAP13[] = {
	 { "NMR", 0, 0, &umr_bitfield_default },
	 { "DEST_OFFSET", 1, 19, &umr_bitfield_default },
	 { "DEST_SEL", 20, 23, &umr_bitfield_default },
	 { "DEST_SEL_RPB", 24, 24, &umr_bitfield_default },
...
static struct umr_bitfield mmXPB_PEER_SYS_BAR10[] = {
	 { "VALID", 0, 0, &umr_bitfield_default },
	 { "ADDR", 1, 31, &umr_bitfield_default },
};
static struct umr_bitfield mmXPB_PEER_SYS_BAR11[] = {
	 { "VALID", 0, 0, &umr_bitfield_default },
	 { "ADDR", 1, 31, &umr_bitfield_default },
};
static struct umr_bitfield mmXPB_PEER_SYS_BAR12[] = {
	 { "VALID", 0, 0, &umr_bitfield_default },
	 { "ADDR", 1, 31, &umr_bitfield_default },
};
static struct umr_bitfield mmXPB_PEER_SYS_BAR13[] = {
	 { "VALID", 0, 0, &umr_bitfield_default },
	 { "ADDR", 1, 31, &umr_bitfield_default },
};
...
static struct umr_bitfield mmXPB_INTF_CFG[] = {
	 ...
	 { "P2P_WR_CHAIN_BREAK", 23, 23, &umr_bitfield_default },
...
static struct umr_bitfield mmRPB_PASSPW_CONF[] = {
	 ...
	 { "ATC_MM_TR_PASSPW_OVERRIDE", 2, 2, &umr_bitfield_default },
	 { "ATC_MM_TR_PASSPW_OVERRIDE_EN", 3, 3, &umr_bitfield_default },
	 { "ATC_MM_RSPPASSPW_OVERRIDE", 4, 4, &umr_bitfield_default },
	 { "ATC_MM_RSPPASSPW_OVERRIDE_EN", 5, 5, &umr_bitfield_default },
	 { "ATC_GFX_TR_PASSPW_OVERRIDE", 6, 6, &umr_bitfield_default },
	 { "ATC_GFX_TR_PASSPW_OVERRIDE_EN", 7, 7, &umr_bitfield_default },
	 { "ATC_GFX_RSPPASSPW_OVERRIDE", 8, 8, &umr_bitfield_default },
	 { "ATC_GFX_RSPPASSPW_OVERRIDE_EN", 9, 9, &umr_bitfield_default },
	 { "ATC_PAGE_PASSPW_OVERRIDE", 10, 10, &umr_bitfield_default },
	 { "ATC_PAGE_PASSPW_OVERRIDE_EN", 11, 11, &umr_bitfield_default },
	 { "ATC_PAGE_RSPPASSPW_OVERRIDE", 12, 12, &umr_bitfield_default },
	 { "ATC_PAGE_RSPPASSPW_OVERRIDE_EN", 13, 13, &umr_bitfield_default },
	 { "WR_PASSPW_OVERRIDE", 14, 14, &umr_bitfield_default },
	 { "WR_RSPPASSPW_OVERRIDE", 15, 15, &umr_bitfield_default },
	 { "RD_PASSPW_OVERRIDE", 16, 16, &umr_bitfield_default },
	 { "RD_RSPPASSPW_OVERRIDE", 17, 17, &umr_bitfield_default },
	 { "ATOMIC_PASSPW_OVERRIDE", 18, 18, &umr_bitfield_default },
	 { "ATOMIC_RSPPASSPW_OVERRIDE", 19, 19, &umr_bitfield_default },
	 { "WRRSP_PASSPW_OVERRIDE", 20, 20, &umr_bitfield_default },
	 { "WRRSP_PASSPW_OVERRIDE_EN", 21, 21, &umr_bitfield_default },
	 { "RDRSP_PASSPW_OVERRIDE", 22, 22, &umr_bitfield_default },
	 { "RDRSP_PASSPW_OVERRIDE_EN", 23, 23, &umr_bitfield_default },
};
static struct umr_bitfield mmRPB_BLOCKLEVEL_CONF[] = {
	 { "XPB_BLOCKLEVEL_OVERRIDE", 0, 1, &umr_bitfield_default },
	 { "XPB_BLOCKLEVEL_OVERRIDE_EN", 2, 2, &umr_bitfield_default },
	 { "ATC_MM_TR_BLOCKLEVEL", 3, 4, &umr_bitfield_default },
	 { "ATC_GFX_TR_BLOCKLEVEL", 5, 6, &umr_bitfield_default },
	 { "ATC_PAGE_BLOCKLEVEL", 7, 8, &umr_bitfield_default },
	 { "ATC_INV_BLOCKLEVEL", 9, 10, &umr_bitfield_default },
	 { "IO_WR_BLOCKLEVEL_OVERRIDE", 11, 12, &umr_bitfield_default },
	 { "IO_WR_BLOCKLEVEL_OVERRIDE_EN", 13, 13, &umr_bitfield_default },
	 { "IO_RD_BLOCKLEVEL_OVERRIDE", 14, 15, &umr_bitfield_default },
	 { "IO_RD_BLOCKLEVEL_OVERRIDE_EN", 16, 16, &umr_bitfield_default },
	 { "ATOMIC_BLOCKLEVEL_OVERRIDE", 17, 18, &umr_bitfield_default },
	 { "ATOMIC_BLOCKLEVEL_OVERRIDE_EN", 19, 19, &umr_bitfield_default },
};
static struct umr_bitfield mmRPB_TAG_CONF[] = {
	 { "RPB_IO_RD", 0, 9, &umr_bitfield_default },
...
static struct umr_bitfield mmRPB_ARB_CNTL[] = {
	 ...
	 { "RPB_VC0_CRD", 26, 30, &umr_bitfield_default },
	 { "DISABLE_FED", 31, 31, &umr_bitfield_default },
};
static struct umr_bitfield mmRPB_ARB_CNTL2[] = {
	 ...
	 { "RPB_VC1_CRD", 24, 28, &umr_bitfield_default },
};
static struct umr_bitfield mmRPB_BIF_CNTL[] = {
	 { "VC0_SWITCH_NUM", 0, 7, &umr_bitfield_default },
	 { "VC1_SWITCH_NUM", 8, 15, &umr_bitfield_default },
	 { "VC2_SWITCH_NUM", 16, 23, &umr_bitfield_default },
	 { "NBIF_DMA_ORIGCLKCTL_EN", 24, 24, &umr_bitfield_default },
	 { "TR_QOS_VC", 25, 27, &umr_bitfield_default },
	 { "RESERVED", 28, 31, &umr_bitfield_default },
};
static struct umr_bitfield mmRPB_BIF_CNTL2[] = {
	 { "ARB_MODE", 0, 0, &umr_bitfield_default },
	 { "DRAIN_VC_NUM", 1, 2, &umr_bitfield_default },
	 { "SWITCH_ENABLE", 3, 3, &umr_bitfield_default },
	 { "SWITCH_THRESHOLD", 4, 11, &umr_bitfield_default },
	 { "PAGE_PRI_EN", 12, 12, &umr_bitfield_default },
	 { "MM_TR_PRI_EN", 13, 13, &umr_bitfield_default },
	 { "GFX_TR_PRI_EN", 14, 14, &umr_bitfield_default },
	 { "VC0_CHAINED_OVERRIDE", 15, 15, &umr_bitfield_default },
	 { "PARITY_CHECK_EN", 16, 16, &umr_bitfield_default },
	 { "NBIF_HST_COMPCLKCTL_EN", 17, 17, &umr_bitfield_default },
...
static struct umr_bitfield mmRPB_ATS_CNTL[] = {
	 ...
	 { "ATCTR_GFX_SWITCH_NUM", 15, 18, &umr_bitfield_default },
	 { "ATCPAGE_SWITCH_NUM", 19, 22, &umr_bitfield_default },
	 { "WR_AT", 23, 24, &umr_bitfield_default },
	 { "MM_VC_SWITCH", 25, 25, &umr_bitfield_default },
	 { "GC_VC_SWITCH", 26, 26, &umr_bitfield_default },
};
static struct umr_bitfield mmRPB_ATS_CNTL2[] = {
	 { "INVAL_COM_CMD", 0, 5, &umr_bitfield_default },
	 { "TRANS_CMD", 6, 11, &umr_bitfield_default },
	 { "PAGE_REQ_CMD", 12, 17, &umr_bitfield_default },
	 { "PAGE_ROUTING_CODE", 18, 20, &umr_bitfield_default },
	 { "INVAL_COM_ROUTING_CODE", 21, 23, &umr_bitfield_default },
	 { "VENDOR_ID", 24, 25, &umr_bitfield_default },
	 { "RPB_VC5_CRD", 26, 30, &umr_bitfield_default },
};
static struct umr_bitfield mmRPB_ATS_CNTL3[] = {
	 { "RPB_ATS_MM_TR", 0, 8, &umr_bitfield_default },
	 { "RPB_ATS_GFX_TR", 9, 17, &umr_bitfield_default },
	 { "RPB_ATS_PR", 18, 26, &umr_bitfield_default },
};
static struct umr_bitfield mmRPB_DF_SDPPORT_CNTL[] = {
	 ...
	 { "DF_RELEASE_CREDIT_MODE", 16, 16, &umr_bitfield_default },
	 { "DF_INSERT_PARITY_ERR", 17, 17, &umr_bitfield_default },
	 { "DF_BUSY_INCLUDE_CONN", 18, 18, &umr_bitfield_default },
	 { "RESERVED", 19, 31, &umr_bitfield_default },
};
