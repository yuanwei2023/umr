...
static struct umr_bitfield mmIH_RB_CNTL[] = {
	 ...
	 { "PAGE_RB_CLEAR", 11, 11, &umr_bitfield_default },
...
static struct umr_bitfield mmIH_CNTL2[] = {
	 { "SELF_IV_FORCE_WPTR_UPDATE_TIMEOUT", 0, 4, &umr_bitfield_default },
...
static struct umr_bitfield mmIH_PERFMON_CNTL[] = {
	 ...
	 { "PERF_SEL0", 2, 11, &umr_bitfield_default },
	 { "ENABLE1", 16, 16, &umr_bitfield_default },
	 { "CLEAR1", 17, 17, &umr_bitfield_default },
	 { "PERF_SEL1", 18, 27, &umr_bitfield_default },
};
...
static struct umr_bitfield mmIH_DSM_MATCH_FCN_ID[] = {
	 { "VF_ID", 0, 4, &umr_bitfield_default },
	 { "PF_VF", 7, 7, &umr_bitfield_default },
};
...
static struct umr_bitfield mmIH_VF_RB_STATUS[] = {
	 { "RB_FULL_DRAIN_VF", 0, 30, &umr_bitfield_default },
};
static struct umr_bitfield mmIH_VF_RB_STATUS2[] = {
	 { "RB_FULL_VF", 0, 30, &umr_bitfield_default },
};
...
static struct umr_bitfield mmIH_RB0_INT_FLOOD_STATUS[] = {
	 { "RB_INT_DROPPED_VF", 0, 30, &umr_bitfield_default },
...
static struct umr_bitfield mmIH_INT_FLOOD_STATUS[] = {
	 ...
	 { "FIRST_DROP_INT_VF_ID", 24, 28, &umr_bitfield_default },
	 { "FIRST_DROP_INT_VF", 29, 29, &umr_bitfield_default },
...
static struct umr_bitfield mmIH_LAST_INT_INFO2[] = {
	 { "PAS_ID", 0, 15, &umr_bitfield_default },
	 { "VF_ID", 16, 20, &umr_bitfield_default },
	 { "VF", 23, 23, &umr_bitfield_default },
};
...
static struct umr_bitfield mmIH_GPU_IOV_VIOLATION_LOG[] = {
	 ...
	 { "VF_ID", 20, 24, &umr_bitfield_default },
};
static struct umr_bitfield mmIH_GPU_IOV_VIOLATION_LOG2[] = {
	 { "INITIATOR_ID", 0, 9, &umr_bitfield_default },
};
static struct umr_bitfield mmIH_COOKIE_REC_VIOLATION_LOG[] = {
	 { "VIOLATION_STATUS", 0, 0, &umr_bitfield_default },
	 { "CLIENT_ID", 8, 15, &umr_bitfield_default },
	 { "INITIATOR_ID", 16, 25, &umr_bitfield_default },
};
...
static struct umr_bitfield mmIH_MEM_POWER_CTRL[] = {
	 { "IH_BUFFER_MEM_POWER_CTRL_EN", 0, 0, &umr_bitfield_default },
	 { "IH_BUFFER_MEM_POWER_LS_EN", 1, 1, &umr_bitfield_default },
	 { "IH_BUFFER_MEM_POWER_DS_EN", 2, 2, &umr_bitfield_default },
	 { "IH_BUFFER_MEM_POWER_SD_EN", 3, 3, &umr_bitfield_default },
	 { "IH_BUFFER_MEM_IDLE_HYSTERESIS", 4, 6, &umr_bitfield_default },
	 { "IH_BUFFER_MEM_POWER_UP_RECOVER_DELAY", 8, 13, &umr_bitfield_default },
	 { "IH_BUFFER_MEM_POWER_DOWN_LS_ENTER_DELAY", 14, 15, &umr_bitfield_default },
};
static struct umr_bitfield mmIH_VF_RB_STATUS3[] = {
	 { "RB_OVERFLOW_VF", 0, 30, &umr_bitfield_default },
};
static struct umr_bitfield mmIH_VF_RB_STATUS4[] = {
	 { "BIF_INTERRUPT_LINE_VF", 0, 30, &umr_bitfield_default },
};
static struct umr_bitfield mmIH_VF_RB1_STATUS3[] = {
	 { "RB_OVERFLOW_VF", 0, 30, &umr_bitfield_default },
};
static struct umr_bitfield mmIH_VF_RB2_STATUS3[] = {
	 { "RB_OVERFLOW_VF", 0, 30, &umr_bitfield_default },
};
...
static struct umr_bitfield mmSEM_CLK_CTRL[] = {
	 ...
	 { "MEM_CLK_SOFT_OVERRIDE", 26, 26, &umr_bitfield_default },
...
static struct umr_bitfield mmSEM_CHICKEN_BITS[] = {
	 ...
	 { "CLIENT_REQ_FCNID_CHECK", 5, 5, &umr_bitfield_default },
	 ...
	 { "VM_INV_FLUSH", 20, 20, &umr_bitfield_default },
};
...
static struct umr_bitfield mmSEM_MEM_POWER_CTRL[] = {
	 { "MEM_POWER_CTRL_EN", 0, 0, &umr_bitfield_default },
	 { "MEM_POWER_LS_EN", 1, 1, &umr_bitfield_default },
	 { "MEM_POWER_DS_EN", 2, 2, &umr_bitfield_default },
	 { "MEM_POWER_SD_EN", 3, 3, &umr_bitfield_default },
	 { "MEM_IDLE_HYSTERESIS", 4, 6, &umr_bitfield_default },
	 { "MEM_POWER_UP_RECOVER_DELAY", 8, 13, &umr_bitfield_default },
	 { "MEM_POWER_DOWN_LS_ENTER_DELAY", 14, 15, &umr_bitfield_default },
};
static struct umr_bitfield mmSEM_GPU_IOV_VIOLATION_LOG2[] = {
	 { "INITIATOR_ID", 0, 9, &umr_bitfield_default },
};
...
static struct umr_bitfield mmIH_ACTIVE_FCN_ID[] = {
	 { "VF_ID", 0, 4, &umr_bitfield_default },
	 { "RESERVED", 5, 30, &umr_bitfield_default },
...
static struct umr_bitfield mmIH_CLIENT_CFG_DATA[] = {
	 { "CREDIT_RETURN_ADDR", 0, 17, &umr_bitfield_default },
	 ...
	 { "INTERFACE_TYPE", 25, 25, &umr_bitfield_default },
};
...
static struct umr_bitfield mmIH_CID_REMAP_DATA[] = {
	 { "CLIENT_ID", 0, 7, &umr_bitfield_default },
	 { "INITIATOR_ID", 8, 17, &umr_bitfield_default },
	 { "CLIENT_ID_REMAP", 24, 31, &umr_bitfield_default },
};
static struct umr_bitfield mmIH_CHICKEN[] = {
	 { "ACTIVE_FCN_ID_PROT_ENABLE", 0, 0, &umr_bitfield_default },
	 { "DBGU_TRIGGER_ENABLE", 1, 1, &umr_bitfield_default },
	 { "CROSS_TRIGGER_ENABLE", 2, 2, &umr_bitfield_default },
	 { "MC_SPACE_FBPA_ENABLE", 3, 3, &umr_bitfield_default },
	 { "MC_SPACE_GPA_ENABLE", 4, 4, &umr_bitfield_default },
	 { "REG_FIREWALL_ENABLE", 5, 5, &umr_bitfield_default },
};
...
static struct umr_bitfield mmIH_INT_DROP_CNTL[] = {
	 { "INT_DROP_EN", 0, 0, &umr_bitfield_default },
	 { "CLIENT_ID_MATCH_EN", 1, 1, &umr_bitfield_default },
	 { "SOURCE_ID_MATCH_EN", 2, 2, &umr_bitfield_default },
	 { "VF_ID_MATCH_EN", 3, 3, &umr_bitfield_default },
	 { "VF_MATCH_EN", 4, 4, &umr_bitfield_default },
	 { "CONTEXT_ID_MATCH_EN", 5, 5, &umr_bitfield_default },
	 { "INT_DROP_MODE", 6, 7, &umr_bitfield_default },
	 { "UTCL2_RETRY_INT_DROP_EN", 8, 8, &umr_bitfield_default },
	 { "INT_DROPPED", 16, 16, &umr_bitfield_default },
};
static struct umr_bitfield mmIH_INT_DROP_MATCH_VALUE0[] = {
	 { "CLIENT_ID_MATCH_VALUE", 0, 7, &umr_bitfield_default },
	 { "SOURCE_ID_MATCH_VALUE", 8, 15, &umr_bitfield_default },
	 { "VF_ID_MATCH_VALUE", 16, 20, &umr_bitfield_default },
	 { "VF_MATCH_VALUE", 23, 23, &umr_bitfield_default },
	 { "CONTEXT_ID_39_32_MATCH_VALUE", 24, 31, &umr_bitfield_default },
};
static struct umr_bitfield mmIH_INT_DROP_MATCH_VALUE1[] = {
	 { "CONTEXT_ID_31_0_MATCH_VALUE", 0, 31, &umr_bitfield_default },
};
static struct umr_bitfield mmIH_INT_DROP_MATCH_MASK0[] = {
	 { "CLIENT_ID_MATCH_MASK", 0, 7, &umr_bitfield_default },
	 { "SOURCE_ID_MATCH_MASK", 8, 15, &umr_bitfield_default },
	 { "VF_ID_MATCH_MASK", 16, 20, &umr_bitfield_default },
	 { "VF_MATCH_MASK", 23, 23, &umr_bitfield_default },
	 { "CONTEXT_ID_39_32_MATCH_MASK", 24, 31, &umr_bitfield_default },
};
static struct umr_bitfield mmIH_INT_DROP_MATCH_MASK1[] = {
	 { "CONTEXT_ID_31_0_MATCH_MASK", 0, 31, &umr_bitfield_default },
};
