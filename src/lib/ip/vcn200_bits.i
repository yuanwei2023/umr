...
static struct umr_bitfield mmUVD_SYS_INT_STATUS[] = {
	 ...
	 { "UVD_HOST_CXW_INT", 8, 8, &umr_bitfield_default },
	 ...
	 { "WPTR_IDLE_INT", 21, 21, &umr_bitfield_default },
	 { "RBC_REG_PRIV_FAULT_IDCT_INT", 22, 22, &umr_bitfield_default },
	 { "SEMA_WAIT_FAIL_SIG_INT", 23, 23, &umr_bitfield_default },
	 { "IDCT_INT", 24, 24, &umr_bitfield_default },
	 { "MPRD_INT", 25, 25, &umr_bitfield_default },
	 { "FCS_INT", 26, 26, &umr_bitfield_default },
...
static struct umr_bitfield mmUVD_LMI_CTRL[] = {
	 ...
	 { "RFU", 28, 31, &umr_bitfield_default },
};
...
static struct umr_bitfield mmUVD_LMI_VM_CTRL[] = {
	 { "VCPU_VM", 0, 0, &umr_bitfield_default },
	 { "CM_VM", 1, 1, &umr_bitfield_default },
	 { "IT_VM", 2, 2, &umr_bitfield_default },
	 { "MP_VM", 3, 3, &umr_bitfield_default },
	 { "DB_VM", 4, 4, &umr_bitfield_default },
	 { "RB_VM", 5, 5, &umr_bitfield_default },
	 { "IB_VM", 6, 6, &umr_bitfield_default },
	 { "CSM_VM", 7, 7, &umr_bitfield_default },
	 { "RB_WR_VM", 8, 8, &umr_bitfield_default },
	 { "DBW_VM", 10, 10, &umr_bitfield_default },
	 { "RB_RPTR_VM", 11, 11, &umr_bitfield_default },
	 { "RE_VM", 12, 12, &umr_bitfield_default },
	 { "SCPU_VM", 13, 13, &umr_bitfield_default },
	 { "ACAP_VM", 14, 14, &umr_bitfield_default },
};
...
static struct umr_bitfield mmUVD_UDEC_ADR[] = {
	 { "SYNC_RE", 7, 7, &umr_bitfield_default },
};
...
static struct umr_bitfield mmUVD_CXW_EN[] = {
	 { "CXW_ENABLE", 0, 0, &umr_bitfield_default },
};
static struct umr_bitfield mmUVD_CXW_SE[] = {
	 { "CXW_SCAN_ENABLE", 0, 0, &umr_bitfield_default },
};
static struct umr_bitfield mmUVD_CXW_FINISHED[] = {
	 { "CXW_FINISHED", 0, 0, &umr_bitfield_default },
};
static struct umr_bitfield mmUVD_CXW_SHIFT_FINISHED[] = {
	 { "SHIFT_FINISHED", 0, 0, &umr_bitfield_default },
};
static struct umr_bitfield mmUVD_CXW_START[] = {
	 { "START_CXW", 0, 0, &umr_bitfield_default },
};
static struct umr_bitfield mmUVD_CXW_BLOCK_STATUS[] = {
	 { "VCPU_IDLE", 0, 0, &umr_bitfield_default },
	 { "LBSI_IDLE", 1, 1, &umr_bitfield_default },
	 { "LMI_IDLE", 2, 2, &umr_bitfield_default },
};
static struct umr_bitfield mmUVD_STOP_CONTEXT[] = {
	 { "STOP_CONTEXT", 0, 0, &umr_bitfield_default },
	 { "CONTEXT_MODE", 1, 1, &umr_bitfield_default },
};
static struct umr_bitfield mmUVD_CXW_SAVE_AREA_ADDR[] = {
	 { "CXW_SAVE_AREA_ADDR", 6, 31, &umr_bitfield_default },
};
...
static struct umr_bitfield mmUVD_CXW_SAVE_AREA_SIZE[] = {
	 { "CXW_SAVE_AREA_SIZE", 0, 31, &umr_bitfield_default },
};
static struct umr_bitfield mmUVD_CONTEXT_ID2[] = {
	 { "CONTEXT_ID2", 0, 31, &umr_bitfield_default },
};
static struct umr_bitfield mmUVD_CXW_CNTL[] = {
	 { "HOST_CXW_EN", 0, 0, &umr_bitfield_default },
	 { "EXTERNAL_CXW_EN", 1, 1, &umr_bitfield_default },
	 { "SEMAPHORE_TIMEOUT_CXW_EN", 3, 3, &umr_bitfield_default },
	 { "HOST_CXW_INT_EN", 4, 4, &umr_bitfield_default },
	 { "EXTERNAL_CXW_INT_EN", 5, 5, &umr_bitfield_default },
	 { "SEMAPHORE_TIMEOUT_CXW_INT_EN", 7, 7, &umr_bitfield_default },
};
static struct umr_bitfield mmUVD_CXW_EVENT[] = {
	 { "HOST_CXW_EVENT_OCCURRED", 0, 0, &umr_bitfield_default },
	 { "EXTERNAL_CXW_EVENT_OCCURRED", 1, 1, &umr_bitfield_default },
	 { "SEMAPHORE_WAIT_INCOMPLETE_TIMEOUT_EVENT_OCCURRED", 3, 3, &umr_bitfield_default },
	 { "SEMAPHORE_WAIT_FAULT_TIMEOUT_EVENT_OCCURRED", 4, 4, &umr_bitfield_default },
	 { "SEMAPHORE_SIGNAL_INCOMPLETE_TIMEOUT_EVENT_OCCURRED", 5, 5, &umr_bitfield_default },
};
static struct umr_bitfield mmUVD_CXW_SCAN_AREA_OFFSET[] = {
	 { "CXW_SCAN_AREA_OFFSET", 0, 25, &umr_bitfield_default },
	 { "CXW_CONTEXT_RESTORE", 26, 26, &umr_bitfield_default },
	 { "CXW_CONTEXT_SAVE", 27, 27, &umr_bitfield_default },
};
static struct umr_bitfield mmUVD_CXW_SHIFT_CNTL[] = {
	 { "SHIFT_CNTL", 0, 0, &umr_bitfield_default },
	 { "SHIFT_COUNT", 1, 11, &umr_bitfield_default },
};
static struct umr_bitfield mmUVD_RBC_CAM_EN[] = {
	 { "RBC_CAM_EN", 0, 0, &umr_bitfield_default },
};
static struct umr_bitfield mmUVD_RBC_CAM_INDEX[] = {
	 { "RBC_CAM_INDEX", 0, 31, &umr_bitfield_default },
};
static struct umr_bitfield mmUVD_RBC_CAM_DATA[] = {
	 { "RBC_CAM_DATA_ORG", 0, 15, &umr_bitfield_default },
	 { "RBC_CAM_DATA_MAP", 16, 31, &umr_bitfield_default },
};
...
static struct umr_bitfield mmUVD_LMI_CRC0[] = {
	 { "CRC32", 0, 31, &umr_bitfield_default },
};
static struct umr_bitfield mmUVD_LMI_CRC1[] = {
	 { "CRC32", 0, 31, &umr_bitfield_default },
};
static struct umr_bitfield mmUVD_LMI_CRC2[] = {
	 { "CRC32", 0, 31, &umr_bitfield_default },
};
static struct umr_bitfield mmUVD_LMI_CRC3[] = {
	 { "CRC32", 0, 31, &umr_bitfield_default },
};
...
static struct umr_bitfield mmUVD_RBC_BDM_PRE[] = {
	 { "BDM_ENABLE", 0, 0, &umr_bitfield_default },
};
static struct umr_bitfield mmCG_TIMESTAMP_LOW[] = {
	 { "CG_LOW", 0, 31, &umr_bitfield_default },
};
static struct umr_bitfield mmCG_TIMESTAMP_HIGH[] = {
	 { "CG_HIGH", 0, 31, &umr_bitfield_default },
};
static struct umr_bitfield mmUVD_UMC_UVD_CTL_CMD[] = {
	 { "CMC_REQ", 0, 0, &umr_bitfield_default },
};
static struct umr_bitfield mmUVD_UMC_UVD_BLOCK_REQ[] = {
	 { "CMC_BLOCK_REQ", 0, 0, &umr_bitfield_default },
};
static struct umr_bitfield mmUVD_RBC_CXW_RELEASE[] = {
	 { "SOFT_RELEASE_RBC", 0, 0, &umr_bitfield_default },
};
...
static struct umr_bitfield mmUVD_ENC_REG_INDEX[] = {
	 { "INDEX", 0, 12, &umr_bitfield_default },
};
static struct umr_bitfield mmUVD_ENC_REG_DATA[] = {
	 { "DATA", 0, 31, &umr_bitfield_default },
};
